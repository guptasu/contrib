...
const TemplateName = "examplereport"

// Instance is constructed by Mixer for the 'examplereport' template.
//
...
// process data associated with the 'examplereport' template.
//
...
type HandlerBuilder interface {
	...
	// SetExampleReportTypes is invoked by Mixer to pass the template-specific Type information for instances that an adapter
	// may receive at runtime. The type information describes the shape of the instance.
	SetExampleReportTypes(map[string]*Type /*Instance name -> Type*/)
}
...
// at configuration time via the method 'SetExampleReportTypes'.
// These Type associated with an instance describes the shape of the instance
type Handler interface {
	adapter.Handler

	// HandleExampleReport is called by Mixer at request time to deliver instances to
	// to an adapter.
	HandleExampleReport(context.Context, []*Instance) error
}
